...
public class WelkinBoatRenderer extends BoatRenderer {
    ...
    private static String getTextureLocation(WelkinBoatEntity.Type pType, boolean pChestBoat) {
        return pChestBoat ? "textures/entity/chest_boat/welkin.png" : "textures/entity/boat/welkin.png";
    }
    ...
    public static ModelLayerLocation createBoatModelName(WelkinBoatEntity.Type type) {
        return createLocation("boat/welkin", "main");
    }

    public static ModelLayerLocation createChestBoatModelName(WelkinBoatEntity.Type type) {
        return createLocation("chest_boat/welkin", "main");
    }
